...
const HAND_WRITTEN: Record<string, ItemDef> = {
  ...
  animal_hide: { kind: 'animal_hide', name: 'Couro de Animal', category: 'loot', stackable: true, buyPrice: 0, sellPrice: 2, color: 0xb59a72 },
  feather: { kind: 'feather', name: 'Pena', category: 'loot', stackable: true, buyPrice: 0, sellPrice: 2, color: 0xefe9dc },
  stone_core: { kind: 'stone_core', name: 'Núcleo de Pedra', category: 'loot', stackable: true, buyPrice: 0, sellPrice: 120, color: 0xc08a4a },
